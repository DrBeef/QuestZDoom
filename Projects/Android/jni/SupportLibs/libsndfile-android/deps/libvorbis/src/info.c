...
double vorbis_granule_time(vorbis_dsp_state *v,ogg_int64_t granulepos){
  ...
  if(granulepos>=0){
    ...
    granuleoff<<=31;
    granuleoff|=0x7ffffffffULL;/*Note the use of "ULL" on 64-bit constants, and the reduced number of
operations required. http://osdir.com/ml/android-ndk/2011-06/msg00641.html*/
