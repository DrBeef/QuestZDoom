...
/* 1 if should enable LADSPA */ // TODO: Could add later
/* #undef HAVE_LADSPA_H */
...
/* Define to 1 if you have the <sys/timeb.h> header file. */ // TODO Some archs have this
...
/* Define to 1 if you have static m4a. */
#define STATIC_M4A 1
