...
extern ControlMode droid_control_mode;
//extern ControlMode dumb_control_mode;
#define DEFAULT_CONTROL_MODE &droid_control_mode
...
ControlMode *ctl_list[]={
  ...
  &winsyn_control_mode,
#endif /* IA_W32GUI */
#if !defined(__MACOS__)  && !defined(IA_W32GUI) && !defined(IA_W32G_SYN) && !defined(__ANDROID_API__)
	&dumb_control_mode,
#endif
#ifdef IA_PLUGIN
  &plugin_control_mode,
